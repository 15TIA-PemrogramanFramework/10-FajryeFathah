	...
	<div class="bgded overlay" style="background-image:url('<?= base_url();?>images/demo/backgrounds/1.png');"> 
		...
		<div id="breadcrumb" class="hoc clear"> 
			...
			<ul>
				...
				<li><a href="percetakan_edit_owner">Edit</a></li>
			</ul>
			<!-- ################################################################################################ -->
		</div>
		<!-- ################################################################################################ -->
	...
	<div class="wrapper row3">
		<main class="hoc container clear"> 
			...
			<div class="content"> 
				...
				<div id="comments">
					<h2>Edit data</h2>
					<form action="<?= site_url('percetakan_owner/edit_aksi');?>" method="post">
						...
						<div class="three_quarter first">
							<a href="<?php echo site_url('percetakan_owner') ?>" class="btn btn-default" >Cancel</a>
						</div>
						<div class="one_quarter">
							<input type="submit" >
						</div>
