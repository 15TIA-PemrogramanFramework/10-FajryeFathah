	...
	<div class="bgded overlay" style="background-image:url('<?= base_url();?>images/demo/backgrounds/1.png');"> 		<!-- ################################################################################################ -->
		...
		<div id="breadcrumb" class="hoc clear"> 
			...
			<ul>
				...
				<li><a href="penjualanatk">Penjualan ATK</a></li>
				<li><a href="penjualanatk_edit">Edit</a></li>
			</ul>
			<!-- ################################################################################################ -->
		</div>
		<!-- ################################################################################################ -->
	...
	<div class="wrapper row3">
		<main class="hoc container clear"> 
			...
			<div class="content"> 
				...
				<div id="comments">
					<h2>Edit data</h2>
					<form action="<?= site_url('penjualanatk/edit_aksi');?>" method="post">
						...
						<div class="three_quarter first">
							<a href="<?php echo site_url('penjualanatk') ?>" class="btn btn-default" >Cancel</a>
						</div>
						<div class="one_quarter">
							<input type="submit">
						</div>						</form>
