<?php
	...
	* 
	*/
	class Penjualanatk_owner extends CI_Controller
	{
		...
		function index()
		{
			...
			$data['penjualanatk_owner']=$this->penjualanatk_model->ambil_data();
			$this->load->view('penjualanatk_owner',$data);
		}
		function tambah()
		{
			$data=array(
				...
				'id'=>set_value('id'),
				'button'=>'Tambah',
				'action'=>site_url('penjualanatk_owner/tambah_aksi'),
			);
			$this->load->view('penjualanatk_owner',$data);
		}
		...
		//untuk balik kehalaman penjualanatk
			redirect(site_url('penjualanatk_owner'));
		}
		function delete($id)
		{
		...
		function edit($id)
		{
			...
			$data = array(
				...
				'button'		=>'edit',
				'action'		=>site_url("penjualanatk_owner/edit_aksi"),
			);
			$this->load->view('penjualanatk_edit_owner',$data);
		}
